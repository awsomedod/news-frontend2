 ...
 */
export function SignUpFormFields({ email, setEmail, username, setUsername, password, setPassword, confirm, setConfirm, 
  showPw, setShowPw, showPw2, setShowPw2, errors }) {
  return (
    <>
